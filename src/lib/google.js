...
qp.Data.prototype.get = function(a, b) {
    var c = a.getAttribute(this.DATA_ATTRIBUTE_ID), d, e;
        ...
        if (goog.events.CAPTURE_SIMULATION_MODE == goog.events.CaptureSimulationMode.ON) {
            if (!goog.events.isMarkedIeEvent_(c)) {
                ...
                for (var f = a.type, g = c.length - 1; !d.propagationStopped_ && 0 <= g; g--)
                    d.currentTarget = c[g], e&=goog.events.fireListeners_(c[g],
                    f, !0, d);
...
qp.ui.Initializer.prototype.initializeUIElements_ = function(a) {
    for (var b = 0, c = a.length; b < c; ++b)
        this.initializeUIElement_(a[b])
};
qp.ui.Initializer.prototype.initializeUIElement_ = function(a) {
    var b = a.getAttribute(qp.ui.Initializer.UI_ATTRIBUTE), b = b ? this.parseUI_(b): {}, c;
    for (c in b)
        b.hasOwnProperty(c) && this.instantiateUI_(a, c, b[c])
};
...
qp.ui.MatchMedia.prototype.addPolyfill = function() {
    var a = goog.dom.getDocument().documentElement, b = a.firstElementChild || a.firstChild, c = goog.dom.createDom("body"), d = goog.dom.createDom("div", {
        id: "mq-test-1"
    });
...
qp.tracking.DownloadTracker.prototype.enableTracking_ = function() {
    for (var a = document.querySelectorAll("a.trackdl"), b = 0; b < a.length; b++)
        goog.events.listen(a[b], goog.events.EventType.CLICK, this.downloadClicked_, !1, this)
};
...
qp.ui.ViewportStateMonitor.prototype.bindResize_ = function() {
    this.handleResize_ = function(a) {
        ...
        for (b; 0 <= b; b -= 1)
            this.mm_.query(this.breakpoints_[b]) && (a = this.config_.breakpoints[this.breakpoints_[b]]);
...
qp.ui.ResponsiveZippy = function(a) {
    var b = qp.ui.ViewportStateMonitor.getInstance().getState();
    - 1 !== ["mobile", "desktop-sm"].indexOf(b) && goog.ui.Zippy.call(this, a, goog.dom.getNextElementSibling(a), !1)
};
...
qp.ui.Peekaboo.prototype.decorateInternal = function(a) {
    ...
    this.getHandler().listen(this.getDomHelper().getWindow(), [goog.events.EventType.SCROLL, goog.events.EventType.RESIZE], this.updatePosition_,
    !1, this);
...
qp.ui.Peekaboo.prototype.updatePosition_ = function() {
    var a = function() {
        for (var a = document.querySelectorAll(".header-wrapper"), c = 0; "undefined" !== typeof a && c < a.length; c++)
            a[c].style.display = "none", DONTOPTIMIZE(a[c].offsetHeight), a[c].style.display = ""
    };
...
goog.Uri.prototype.toString = function() {
    ...
    if (b = this.getPath())
        this.hasDomain() && "/" != b.charAt(0) && a.push("/"), a.push(goog.Uri.encodeSpecialChars_(b, "/" == b.charAt(0) ?
...
goog.math.Line.prototype.getSegmentLengthSquared = function() {
    var a = this.x1 - this.x0, b = this.y1 - this.y0;
    return a * a + b * b
};
...
gweb.ui.SmoothScroll.prototype.scrollTo = function(a, b) {
    ...
    var c = this.calculateScrollDuration_(), c = new goog.fx.Animation([this.currentCoord_.x, this.currentCoord_.y], [a.x, a.y], c, this.scrollTimingFn_);
...
gweb.ui.SmoothScroll.prototype.isValidURL_ = function(a) {
    a = goog.Uri.parse(a);
    var b = a.getDomain() + a.getPath(), c = goog.Uri.parse(window.location.hostname + window.location.pathname), c = c.getDomain() + c.getPath();
...
qp.ui.SideNavDrawer.prototype.show = function() {
    var a = this.getDomHelper().getDocument(), b = goog.bind(goog.events.listen, goog.events, a.body, this.externalClickEvent_, this.handleExternalClick_, !1, this);
    setTimeout(b);
...
qp.ui.ScrollSpyMonitor.prototype.update_ = function(a) {
    ...
    for (var b =- Infinity, c = "", d = 0, e = a.length; d < e; ++d) {
        var f = a[d], g = f.getBoundingClientRect().top;
        0 >= g && g > b && (c = f.id, b = g)
    }
...
qp.ui.Futurizr = function(a, b) {
    var c = qp.ui.Features.getInstance(), d;
    for (d in b)
        b.hasOwnProperty(d) && goog.isFunction(c[d]) && goog.dom.classes.enable(a, b[d], c[d]())
};
